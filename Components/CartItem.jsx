    ...
    return (
        <tr>
            ...
            <td style={{ minWidth: '200px' }} className="w-50 align-middle" >
                ...
                {
                    item.inStock > 0 ? <p className='mb-1 text-danger'>Số lượng còn : {item.inStock}</p>
                        : <p className='mb-1 text-danger'>Sản phẩm hiện đã hết hàng</p>
                }
            ...
            <td className='align-middle' style={{ minWidth: '50px', cursor: 'pointer' }}>
                <i className='far fa-trash-alt text-danger' aria-hidden="true" style={{ fontSize: '18px' }} data-toggle="modal" data-target="#exampleModal" onClick={() => {
                    dispatch({
                        type: 'ADD_MODAL',
